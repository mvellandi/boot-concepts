import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL$1, k as encodePath$1, l as decodePath, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as defu, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_J2_MBTZf25Gulw7UtVQf6FqAR024tSXcHs6MfXSQptQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "testimonials",
    path: "/testimonials",
    component: () => import('./index-DwZ-5rQu.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-irGAyjhi.mjs')
  }
];
...
const revive_payload_server_QOFw7tQVesn73XgG4pMyht7aIpBTOvR2WWXUORJUcPE = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_J2_MBTZf25Gulw7UtVQf6FqAR024tSXcHs6MfXSQptQ,
  plugin,
  revive_payload_server_QOFw7tQVesn73XgG4pMyht7aIpBTOvR2WWXUORJUcPE,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-DcgKvVL1.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Zi-3gC2V.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DZm2YsMq.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@biom_9392a5008eaf9df134d6bd4b86acec35/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@biom_9392a5008eaf9df134d6bd4b86acec35/node_modules/nuxt/dist/app/components/nuxt-root.vue");
